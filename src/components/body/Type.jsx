...
function Type() {
  ...
  return (
        <section className='type_main' >
            <div className='type_head_text' onClick={()=>handleActiveClick()} ><span className='type_head_span'>TYPE</span><img src={arrow_down} alt="" className={`type_head_img ${active===true?'':'rotate'}`} /></div>
            <div className={`${active===true?'type_content':'type_content_none'}`} >
                <div className='type_search' >
                    ...
                    <div className='more_elements' >
                        <span className='more_text'>521 MORE</span>
                    </div>
                </div>
        </section>
  )
